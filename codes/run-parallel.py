...
for audio_file in audio_files:
    ...
    print(f"{output_dir}/raw/{file_id}.json")
    if os.path.exists(f"{output_dir}/raw/{file_id}.json"):
            print(f"{output_dir}/raw/{file_id}.json exists")
            continue
    ...
    with open(f"{output_dir}/raw/{file_id}.json", 'w', encoding='utf-8') as f:
        print(f"dumping {output_dir}/raw/{file_id}.json")
